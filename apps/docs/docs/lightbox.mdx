...
### Compound component example - Mantine Image

Use Mantine's `Image` component inside `Lightbox.Slide` and `Lightbox.Thumbnail`.

<Demo data={demos.compoundMantineImage} />

### Compound component example - Next.js Image

Use Next.js `Image` component inside `Lightbox.Slide` and `Lightbox.Thumbnail`.

<Demo data={demos.compoundNextImage} />
