		...
		<>
			<div className={classes.groupsHeader}>
				...
				<MdxParagraph style={{ marginTop: 0 }}>
					...
					. With Styles API, you can customize styles of any inner element.
					Follow{" "}
					<MdxLink href="https://mantine.dev/styles/styles-api" target="_blank">
						the documentation
					</MdxLink>{" "}
					to learn how to use CSS modules, CSS variables and inline styles to
					get full control over component styles.
				</MdxParagraph>
			</div>
			{tables}
		</>
